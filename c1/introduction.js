...
values.forEach(value => {
  if (!value) {
    // Be careful, take a look at the differences wit the previous example
...
`${obj.address.street}, ${obj.address.city}``${obj["address"]["street"]}, ${
  obj["address"]["city"]
}`;
...
//raw.githubusercontent.com/getify/You-Dont-Know-JS/master/scope%20%26%20closures/fig2.png
https: // Closures
